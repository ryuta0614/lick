//+------------------------------------------------------------------+
//| rsi_mean_reversion_001.mq4 -- GENERATED by src/generators/mql4_generator.py |
//| DO NOT EDIT BY HAND. Edit strategy_specs/rsi_mean_reversion_001.json and regenerate. |
//| StrategySpec: RSI Mean Reversion (version 1) |
...
void OnTick()
{
   ...
   bool longSignal = Ind_CrossesAbove(Ind_RSI(Symbol(), TradingTimeframe, 14, 1), Ind_RSI(Symbol(), TradingTimeframe, 14, 2), 30, 30);
   if (longSignal) HandleSignal(OP_BUY, lot);

   bool shortSignal = Ind_CrossesBelow(Ind_RSI(Symbol(), TradingTimeframe, 14, 1), Ind_RSI(Symbol(), TradingTimeframe, 14, 2), 70, 70);
